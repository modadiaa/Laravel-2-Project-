                ...
                <div class="modal-body">
                    <form action="{{route('news.store')}}" method="POST" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="title">  @lang('site.title_about_ar')</label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="title">  @lang('site.title_about_en')</label>
    ...
    <div class="table-responsive">
        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
            ...
            @foreach ($news as $key =>  $nee)
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                    data-target="#edit{{ $nee->id }}"
                                    title="Edit"><i class="fa fa-edit"></i></button>
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                    data-target="#delete{{ $nee->id }}"
                                    title="Delete"><i
                    ...
                    <!-- edit_modal_Grade -->
                    <div class="modal fade" id="edit{{ $nee->id }}" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <!-- edit_form -->
                                    <form action="{{route('news.update','test')}}" method="post"  enctype="multipart/form-data">
                                        {{ method_field('put') }}
                                        @csrf
                                        <input type="hidden" name="nee_id" value="{{ $nee->id }}">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="fname">   @lang('site.name_about') </label>
                                                    <input required="required" value="{{ $nee->name}}" name = "name" type="text" class="@error('name') is-invalid
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input required="required" value="{{ $nee->slug}}" name ="slug" type="text" class="@error('name') is-invalid
                                                     @enderror form-control" id="fname" aria-describedby="emailHelp">
                                                    @error('name')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input required="required" value="{{ $nee->title}}" name ="title" type="text" class="@error('title') is-invalid
                                            ...
                                            <div class="col-12">
                                                ...
                                                <textarea required="required" name="description" id="" cols="30" rows="10"
                                                class="@error('description') is-invalid
                                                @enderror form-control ckeditor">{!! $nee->description !!}</textarea>
                                                @error('description')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-12">
                                               ...
                                               <textarea required="required" value="{{ $nee->keyword}}" name="keyword" id="" cols="30" rows="10"
                                               class="@error('description') is-invalid
                                               @enderror form-control ckeditor">{!! $nee->keyword !!}</textarea>
                                               @error('keyword')
                                               <div class="alert alert-danger">{{ $message }}</div>
                                               @enderror
                                           </div>
                                           ...
                                           <div class="col-12">
                                               ...
                                               <textarea required="required" value="{{ $nee->optionn}}" name="optionn" id="" cols="30" rows="10"
                                               class="@error('description') is-invalid
                                               @enderror form-control ckeditor">{!! $nee->optionn !!}</textarea>
                                               @error('optionn')
                                               <div class="alert alert-danger">{{ $message }}</div>
                                               @enderror
                                           </div>
                    ...
                    <!-- delete_modal_Grade -->
                    <div class="modal fade" id="delete{{ $nee->id }}" tabindex="-1" role="dialog"
                         aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('news.destroy','test')}}"
                                        ...
                                        @csrf
                                        @lang('site.areyou')
                                        <input id="id" type="hidden" name="nee_id" class="form-control"
                                               value="{{ $nee->id }}">
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">@lang('site.close')</button>
