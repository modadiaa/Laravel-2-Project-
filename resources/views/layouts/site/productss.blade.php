 ...
 <div class="container-xxl py-5 ll">
    <div class="container">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="display-5 mb-5">{{ $category->name }}</h1>
        </div>
        <div class="row g-4">

            @foreach (\App\Models\Category::where('parent',$category->id)->with('products')->get() as $categories => $category)
                ...
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <div class="text-center p-4">
                            <a href="{{ url('category/'.$category->slug.'/'.$category->slug) }}">
                                <h5 class="mb-0"> {{ $category->name }} </h5>
                            </a>
                            <span class="text-primary">{{ $category->description }}  </span>
                        </div>
                    </div>
                </div>
                @endif
